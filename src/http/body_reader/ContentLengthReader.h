...
{
public:
    ContentLengthReader(net::TcpConnectionPtr conn, utils::StringBuffer & buffer, size_t contentLength)
        : conn_(std::move(conn)), buffer_(buffer), contentLength_(contentLength) {}
