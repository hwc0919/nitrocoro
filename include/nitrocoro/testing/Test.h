...
#define NITRO_CHECK_EQ(a, b) NITRO_CHECK((a) == (b))
#define NITRO_CHECK_NE(a, b) NITRO_CHECK((a) != (b))
...
#define NITRO_REQUIRE_EQ(a, b) NITRO_REQUIRE((a) == (b))
#define NITRO_REQUIRE_NE(a, b) NITRO_REQUIRE((a) != (b))
